...
4. **Database Setup**
   ...
   Run `supabase/manual-payments-migration.sql` to enable bank transfer payments, payment-proof uploads, and the admin pending-payments queue. Add bank details in Admin > Payments, then customers can select Bank transfer, upload proof, and click `I've Paid`.
